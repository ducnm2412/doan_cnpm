...
import com.docpet.animalhospital.domain.DiseaseFish;
...
@Repository
public interface DiseaseFishRepository extends JpaRepository<DiseaseFish, Long> {

    @Query("SELECT d FROM DiseaseFish d WHERE " +
    ...
    List<DiseaseFish> searchByKeyword(@Param("keyword") String keyword, Pageable pageable);
}
