...
import com.docpet.animalhospital.domain.DiseaseMouse;
...
@Repository
public interface DiseaseMouseRepository extends JpaRepository<DiseaseMouse, Long> {

    @Query("SELECT d FROM DiseaseMouse d WHERE " +
    ...
    List<DiseaseMouse> searchByKeyword(@Param("keyword") String keyword, Pageable pageable);
}
