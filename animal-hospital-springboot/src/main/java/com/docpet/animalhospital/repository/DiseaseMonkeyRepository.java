...
import com.docpet.animalhospital.domain.DiseaseMonkey;
...
@Repository
public interface DiseaseMonkeyRepository extends JpaRepository<DiseaseMonkey, Long> {

    @Query("SELECT d FROM DiseaseMonkey d WHERE " +
    ...
    List<DiseaseMonkey> searchByKeyword(@Param("keyword") String keyword, Pageable pageable);
}
