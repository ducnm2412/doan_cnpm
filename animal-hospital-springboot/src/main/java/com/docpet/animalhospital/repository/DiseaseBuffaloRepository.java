...
import com.docpet.animalhospital.domain.DiseaseBuffalo;
...
@Repository
public interface DiseaseBuffaloRepository extends JpaRepository<DiseaseBuffalo, Long> {

    @Query("SELECT d FROM DiseaseBuffalo d WHERE " +
    ...
    List<DiseaseBuffalo> searchByKeyword(@Param("keyword") String keyword, Pageable pageable);
}
