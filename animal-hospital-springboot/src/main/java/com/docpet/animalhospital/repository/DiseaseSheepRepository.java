...
import com.docpet.animalhospital.domain.DiseaseSheep;
...
@Repository
public interface DiseaseSheepRepository extends JpaRepository<DiseaseSheep, Long> {

    @Query("SELECT d FROM DiseaseSheep d WHERE " +
    ...
    List<DiseaseSheep> searchByKeyword(@Param("keyword") String keyword, Pageable pageable);
}
