...
import com.docpet.animalhospital.domain.DiseaseSnake;
...
@Repository
public interface DiseaseSnakeRepository extends JpaRepository<DiseaseSnake, Long> {

    @Query("SELECT d FROM DiseaseSnake d WHERE " +
    ...
    List<DiseaseSnake> searchByKeyword(@Param("keyword") String keyword, Pageable pageable);
}
