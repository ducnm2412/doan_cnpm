...
import com.docpet.animalhospital.domain.DiseasePig;
...
@Repository
public interface DiseasePigRepository extends JpaRepository<DiseasePig, Long> {

    @Query("SELECT d FROM DiseasePig d WHERE " +
    ...
    List<DiseasePig> searchByKeyword(@Param("keyword") String keyword, Pageable pageable);
}
