...
import com.docpet.animalhospital.domain.DiseaseCow;
...
@Repository
public interface DiseaseCowRepository extends JpaRepository<DiseaseCow, Long> {

    @Query("SELECT d FROM DiseaseCow d WHERE " +
    ...
    List<DiseaseCow> searchByKeyword(@Param("keyword") String keyword, Pageable pageable);
}
