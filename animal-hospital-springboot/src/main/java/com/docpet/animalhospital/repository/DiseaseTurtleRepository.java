...
import com.docpet.animalhospital.domain.DiseaseTurtle;
...
@Repository
public interface DiseaseTurtleRepository extends JpaRepository<DiseaseTurtle, Long> {

    @Query("SELECT d FROM DiseaseTurtle d WHERE " +
    ...
    List<DiseaseTurtle> searchByKeyword(@Param("keyword") String keyword, Pageable pageable);
}
