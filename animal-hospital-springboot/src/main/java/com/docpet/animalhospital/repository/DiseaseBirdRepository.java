...
import com.docpet.animalhospital.domain.DiseaseBird;
...
@Repository
public interface DiseaseBirdRepository extends JpaRepository<DiseaseBird, Long> {

    @Query("SELECT d FROM DiseaseBird d WHERE " +
    ...
    List<DiseaseBird> searchByKeyword(@Param("keyword") String keyword, Pageable pageable);
}
