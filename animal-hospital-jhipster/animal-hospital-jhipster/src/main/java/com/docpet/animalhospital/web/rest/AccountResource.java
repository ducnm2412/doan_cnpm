...
public class AccountResource {
    ...
    public void registerAccount(@Valid @RequestBody ManagedUserVM managedUserVM) {
        ...
        // User is activated immediately, no email activation needed
    }
    ...
    /**
     * {@code POST  /register-vet} : register a new vet/doctor.
     *
     * @param vetRegistrationVM the vet registration View Model.
     * @throws InvalidPasswordException {@code 400 (Bad Request)} if the password is incorrect.
     * @throws EmailAlreadyUsedException {@code 400 (Bad Request)} if the email is already used.
     * @throws LoginAlreadyUsedException {@code 400 (Bad Request)} if the login is already used.
     */
    ...
    public void registerVet(@Valid @RequestBody VetRegistrationVM vetRegistrationVM) {
        ...
        // Vet is activated immediately, no email activation needed
    }
