...
public class UserService {
    ...
    public User registerUser(AdminUserDTO userDTO, String password) {
        ...
        // new user is activated immediately (no email activation needed)
        ...
        // Tự động tạo Owner profile với name = firstName + " " + lastName
        Owner owner = new Owner();
        String fullName = buildFullName(userDTO.getFirstName(), userDTO.getLastName());
        owner.setName(fullName);
        owner.setPhone(""); // User có thể cập nhật sau
        owner.setAddress(""); // User có thể cập nhật sau
    ...
    public User registerVet(VetRegistrationVM vetRegistrationVM, String password) {
        ...
        // new vet is activated immediately (no email activation needed)
        newUser.setActivated(true);
        Set<Authority> authorities = new HashSet<>();
        ...
        // Tự động tạo Vet profile với licenseNo từ registration
        Vet vet = new Vet();
        ...
        LOG.debug("Created Information for Vet: {}", newUser);
        return newUser;
    }
    ...
    public User registerAssistant(AssistantRegistrationVM assistantRegistrationVM, String password) {
        ...
        // new assistant is active immediately (created by doctor)
        newUser.setActivated(true);
        Set<Authority> authorities = new HashSet<>();
     ...
     * @return full name with space between first and last name, trimmed
     */
